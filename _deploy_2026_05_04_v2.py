"""Deploy 2026-05-04 v2 — onboarding refinements + badge label refinements."""
...
print("=== Phase A — upload installer + run + delete ===")
f = connect()
try:
    stor(f, "site/_mgs_onboarding_refresh_v2.php", "_mgs_onboarding_refresh_v2.php")
finally: f.quit()
body = hit(f"https://{HOST}/_mgs_onboarding_refresh_v2.php?token={TOKEN}")
print("  " + body.replace("\n", "\n  "))
delete("_mgs_onboarding_refresh_v2.php")

print("\n=== Phase B — upload templates ===")
f = connect()
try:
    stor(f, "site/upstream/_frameworks/main/impact/onboarding.html",
         "_frameworks/main/impact/onboarding.html")
    stor(f, "site/upstream/_frameworks/main/impact/_list_users_info.html",
         "_frameworks/main/impact/_list_users_info.html")
finally: f.quit()

print("\n  (templates only — no opcache reset needed)")
print("\nDONE")
