"""Deploy 2026-05-04 — MatchScore class + Users_List::show injection.
Two PHP files → OPcache reset required.
"""
...
print("=== Upload match_score.class.php + userslist.class.php + opcache reset endpoint ===")
f = connect()
try:
    stor(f, "site/upstream/_include/current/match_score.class.php",
         "_include/current/match_score.class.php")
    stor(f, "site/upstream/_include/current/userslist.class.php",
         "_include/current/userslist.class.php")
