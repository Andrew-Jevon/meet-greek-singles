"""Deploy 2026-05-04 — prelaunch ajax allowlist fix.
Adds 'login' so members can log back in during pre-launch.
"""
...
print("=== Upload prelaunch.class.php + opcache reset ===")
f = connect()
try:
    stor(f, "site/upstream/_include/current/prelaunch.class.php",
