...
if ($optionSet == 'urban') {
    $width = max(1, get_param_int('width_captcha', Common::getOption('width_captcha', 'template_options')));
    $height = max(1, get_param_int('height_captcha', Common::getOption('height_captcha', 'template_options')));
} else {
    $ratioFontSize = 2;
    $ratioDistancee = 1.8;
}
