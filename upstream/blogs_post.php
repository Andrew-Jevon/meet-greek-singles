...
if ((Common::isOptionActive('list_blog_posts_hide_from_guests', 'edge_general_settings') || Common::isOptionActive('list_blog_post_page_hide_from_guests', 'edge_general_settings')) && !guid()) {
    Common::toLoginPage();
}
