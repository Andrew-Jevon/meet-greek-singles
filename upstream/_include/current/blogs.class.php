...
class Blogs extends CHtmlBlock
{
    ...
    static function addPost($id = null)
    {
        ...
        $text = removeTagAttributes($text, array('href'));
    ...
    static function parseComments(&$html, $id)
    {
        ...
        if ($comments && $showCommentId && $isGetLoadComments) {
            ...
            Common::parseDrawerBlock($html, 'blog_post_comment_top_drawer');
            Common::parseDrawerBlock($html, 'blog_post_comment_bottom_drawer');
    ...
    static function addComment($isNotifComments = true)
    {
        ...
        if ($blogId && ($msg != '' || $audioMessageId || $imageUpload || $imageDrawer)) {
