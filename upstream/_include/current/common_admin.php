...
if($p === 'user_menu_order_edit.php') {
    if(!isset($l[$p]['title_current']) && isset($l['pages_edit.php']['title_current'])) {
        $l[$p]['title_current'] = $l['pages_edit.php']['title_current'];
    }
} elseif ($p === 'user_menu_order_add.php') {
    if(!isset($l[$p]['title_current']) && isset($l['pages_add.php']['title_current'])) {
        $l[$p]['title_current'] = $l['pages_add.php']['title_current'];
    }
}
...
class CAdminHeader extends CHtmlBlock
{
    ...
    protected $linkToMainMenu = array(
                                    'news' => 'help_topic.php',
                                    'user_menu_order' => 'user_menu_order.php',
                                );
	...
	function parseBlock(&$html)
	{
		...
		elseif(in_array($filename, array('user_menu_order.php', 'user_menu_order_edit.php', 'user_menu_order_add.php', 'site_options.php', 'image.php', 'menu.php', 'smtp.php', 'date_options.php', 'main_col_order.php', 'right_col_order.php', 'profile_col_narrow.php', 'header_menu_order.php', 'submenu_order.php', 'quick_search_order.php','profile_tabs_order.php','visitor_menu_order.php')))
		{
			$menu = "soptions";
		}
...
class CAdminConfig extends CHtmlBlock {
	...
	private $notAvailableOptionTemplate = array(
        ...
        'edge' => array(
            ...
            'flashchat',
            //Active features
            'wall_enabled', 'wink', 'gifts_enabled', 'profile_status',
    ...
    private $notAvailableDateFormatsTemplate = array(
        ...
        'edge' => array(
            'general_chat', 'gift_date', 'photo_comment_date'
        )
    );
...
class CAdminPageMenuFakes extends CAdminPageMenu {
    ...
    protected $notAvailableItemsTemplate = array(
        ...
        'edge' => array('fakes_reply_winks.php'),
    );
...
class CAdminPageMenuMusic extends CAdminPageMenu {
    ...
    protected $notAvailableItemsTemplate = array(
        'edge' => array('music_musicians.php', 'music_musician_comments.php', 'music_song_comments.php', 'music_categories.php', 'music_category_add.php'),
    );
}
