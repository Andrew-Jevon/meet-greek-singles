...
class CWallPage extends CHtmlBlock {
    ...
    function parseBlock(&$html)
    {
        ...
        if ($guid && !$item && $isParseModuleItrmAdd && $html->blockExists('wall_item_add_field')) {
            Common::parseDrawerBlock($html, 'wall_item_add_field_drawer');
        ...
        Common::parseDrawerBlock($html, 'wall_comment_drawer_pp_wall_feed_comment_top');
        Common::parseDrawerBlock($html, 'wall_comment_drawer_pp_wall_feed_comment_bottom');
