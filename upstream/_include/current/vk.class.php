...
class vk
{
    ...
    public function oAuthApi()
    {
        ...
        if (isset($_GET['code'])) {
            ...
            $params['scope'] = 'email';
            $token = json_decode(urlGetContents('https://oauth.vk.ru/access_token', 'get', $params), true);
            ...
            if (isset($token['access_token'])) {
                ...
                $userInfo = json_decode(urlGetContents('https://api.vk.ru/method/users.get', 'get', $params), true);
