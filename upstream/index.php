...
class CIndex extends CHeader
{
	...
	function parseBlock(&$html)
	{
        ...
        // M4: render the pre-launch banner on the homepage when platform_mode=prelaunch
        if (class_exists('Prelaunch') && Prelaunch::isPrelaunch() && $html->blockexists('prelaunch_banner')) {
            $html->parse('prelaunch_banner');
        }
