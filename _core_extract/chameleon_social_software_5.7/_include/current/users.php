...
class CUsersProfile extends CUsers {
    ...
    function onItemImpact(&$html, $row, $i, $last) {
        ...
        if ($isMyProfile) {
            ...
            if(!guid()) {
                $html->parse('profile_info_visitor_profile_charts_hide', false);
                $html->parse('profile_info_visitor_module_buttons', false);
            } else {
                $html->parse('profile_info_visitor_authorized_buttons', false);
            }
