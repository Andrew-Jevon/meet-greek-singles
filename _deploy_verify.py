"""Deploy + run + delete the post-deploy verifier."""
...
def main():
    ...
    print("Uploading verifier...")
    f = connect()
    try:
        stor(f, "site/_mgs_verify_2026_05_01.php", "_mgs_verify_2026_05_01.php")
    finally:
        f.quit()

    print("\nRunning verifier...\n")
    body = hit(f"https://{HOST}/_mgs_verify_2026_05_01.php?token={TOKEN}")
    print(body)

    print("\nDeleting verifier...")
    f = connect()
    try:
        f.cwd("/"); f.delete("_mgs_verify_2026_05_01.php")
    finally:
        f.quit()
    print("DONE")
